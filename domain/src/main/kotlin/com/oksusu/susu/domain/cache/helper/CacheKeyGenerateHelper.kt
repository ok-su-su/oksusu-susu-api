...
class CacheKeyGenerateHelper {
    suspend fun getUserStatisticKey(uid: Long): String {
        return "${com.oksusu.susu.common.consts.USER_STATISTIC_KEY_PREFIX}$uid"
    }

    suspend fun getSusuSpecificStatisticKey(age: Long, categoryId: Long, relationshipId: Long): String {
        return "${com.oksusu.susu.common.consts.SUSU_SPECIFIC_ENVELOPE_STATISTIC_KEY_PREFIX}$age:$categoryId:$relationshipId"
    }

    suspend fun getSusuSpecificStatisticKey(key: String): String {
        return "${com.oksusu.susu.common.consts.SUSU_SPECIFIC_ENVELOPE_STATISTIC_KEY_PREFIX}$key"
    }

    suspend fun getSusuCategoryStatisticKey(id: Long): String {
        return "${com.oksusu.susu.common.consts.SUSU_CATEGORY_ENVELOPE_STATISTIC_KEY_PREFIX}$id"
    }

    suspend fun getSusuRelationshipStatisticKey(id: Long): String {
        return "${com.oksusu.susu.common.consts.SUSU_RELATIONSHIP_ENVELOPE_STATISTIC_KEY_PREFIX}$id"
    }
}
