...
@Repository
class SuspendableSusuEnvelopeStatisticRepository(
    private val cacheService: CacheService,
) : SusuEnvelopeStatisticRepository {
    override suspend fun save(value: SusuEnvelopeStatistic) {
    ...
    override suspend fun getStatistic(): SusuEnvelopeStatistic? {
